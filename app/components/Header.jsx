...
export default function Header({
  ...
  return (
    <SafeAreaView className="bg-[#F66C3A] rounded-b-[32px]" edges={['top']}>
      ...
      <View className="bg-[#F66C3A] rounded-b-[26px] px-4 pt-3 pb-4 shadow-lg">
        ...
        <View className="mt-4">
          ...
          >
            ...
            >
              <View
                className={`flex-row items-center px-5 py-2.5 rounded-full border ${activeCategory === "All"
                    ? "bg-white border-white shadow-md"
                    : "bg-white/10 border-white/25"
                  }`}
              >
                <View
                  className={`w-8 h-8 rounded-full items-center justify-center ${activeCategory === "All" ? "bg-[#F66C3A]/10" : "bg-white/15"
                    }`}
                >
                  <Ionicons
                    name="apps-outline"
                ...
                <Text
                  className={`ml-2 text-[13px] font-outfit-bold ${activeCategory === "All" ? "text-[#F66C3A]" : "text-white"
                    }`}
                >
                  All
                </Text>
              ...
              return (
                ...
                >
                  ...
                  >
                    ...
                    <Text
                      numberOfLines={1}
                      className={`ml-2 text-[13px] font-outfit-bold max-w-[110px] ${isActive ? "text-[#F66C3A]" : "text-white"
                        }`}
                    >
                      {category.name}
                    </Text>
